...
base::saveRDS(DF123, file = "D:/Emperors/Sea-Ice-on-Emperor-Penguin-Colonies/Bear_Peninsula.Rds")
...
(ggplot(data = subset(climS,t>'2021-12-31'), aes(x = t, y = sicMean)) +
    geom_flame(aes(y = sicMean,y2=seas, fill = "Normal")) +
    geom_flame(aes(y = thresh,y2=sicMean, fill = "Moderate")) +
    geom_flame(aes(y = thresh_2x,y2=sicMean, fill = "Strong")) +
    geom_line(aes(y = seas, col = "Climatology"), size = 0.7,linetype="dashed") +
    geom_line(aes(y = thresh, col = "Threshold"), size = 0.7,linetype="dotted") +
    geom_line(aes(y = thresh_2x, col = "2x Threshold"), size = 0.7,linetype="dotdash") +
...
eveS<-subset(eveS,date_start>'2021-12-31',select=c(site_id,duration))
eveS
